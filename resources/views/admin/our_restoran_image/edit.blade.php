        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.our_restoran_image.update',$our_restoran_image) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <img src="{{ asset($our_restoran_image->image) }}" alt="" style="width: 100px">
                                            </div>
                                        </div>
                                    </div>
                                </div>
