        ...
        <div class="content full-height hero-content">
            <div class="slideshow-container" data-top-bottom="transform: translateY(300px);"
                ...
                <div class="slides-container">
                    <!-- 1 -->
                    <div class="bg" style="background-image: url({{ asset('frontend/images/bg/1.jpg') }})"></div>
                    <!-- 2 -->
                    <div class="bg" style="background-image: url({{ asset('frontend/images/bg/1.jpg') }})"></div>
                    <!-- 3 -->
                    <div class="bg" style="background-image: url({{ asset('frontend/images/bg/1.jpg') }})"></div>
        ...
        <div class="content">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>The History of Kitchens and Cooks gives further intimation on Mr Boulanger usual menu,
                                stating confidently that "Boulanger served salted poultry and fresh eggs, all presented
                                without a tablecloth on small marble tables". Numerous commentators have also referred to
                                the supposed restaurant owner's eccentric habit of touting for custom outside his
                                establishment, dressed in aristocratic fashion and brandishing a sword</p>
                            <p> Numerous commentators have also referred to the supposed restaurant owner's eccentric habit
                                of touting for custom outside his establishment, dressed in aristocratic fashion and
                        ...
                        <div class="col-md-6">
                            <div class="single-slider-holder">
                                ...
                                <div class="single-slider owl-carousel">
                                    <!-- 1 -->
                                    <div class="item">
                                        <img src="{{ asset('frontend/images/bg/1.jpg') }}" class="respimg" alt="">
                                    </div>
                                    <!-- 2 -->
                                    <div class="item">
                                        <img src="{{ asset('frontend/images/bg/1.jpg') }}" class="respimg" alt="">
            ...
            <section class="parallax-section">
                <div class="media-container video-parallax" data-top-bottom="transform: translateY(300px);"
                    data-bottom-top="transform: translateY(-300px);">
                    <div class="bg mob-bg" style="background-image: url({{ asset('frontend/images/bg/18.jpg') }})"></div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="single-slider-holder">
                                ...
                                <div class="single-slider owl-carousel">
                                    <!-- 1 -->
                                    <div class="item">
                                        <img src="{{ asset('frontend/images/slider/1.jpg') }}" class="respimg"
                                            alt="">
                                    </div>
                                    <!-- 2 -->
                                    <div class="item">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>The History of Kitchens and Cooks gives further intimation on Mr Boulanger usual menu,
                                ...
                                the supposed restaurant owner's eccentric habit of touting for custom outside his
                                establishment, dressed in aristocratic fashion and brandishing a sword</p>
                            <p>Restaurant owner's eccentric habit of touting for custom outside his establishment, dressed
            ...
            <!--=============== Weekly Deals ===============-->
            <section class="parallax-section">
                <div class="bg bg-parallax" style="background-image:url({{ asset('frontend/images/bg/1.jpg') }})"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="promotion-item">
                                ...
                                <div class="promotion-details">
                                    ...
                                    <div class="promotion-prices"><span class="promotion-price">$34</span><span
                                            class="promotion-discount">$26</span></div>
                                </div>
                            </div>
                        </div>
                        <!-- 2 -->
                        <div class="col-md-12">
                            <div class="promotion-item">
                                ...
                                <div class="promotion-details">
                                    ...
                                    <div class="promotion-dot"></div>
                                    <div class="promotion-prices"><span class="promotion-price">$130</span><span
                                            class="promotion-discount">$90</span></div>
                                </div>
                            </div>
                        </div>
                        <!-- 3 -->
                        <div class="col-md-12">
                            <div class="promotion-item">
                                ...
                                <div class="promotion-details">
                                    ...
                                    <div class="promotion-dot"></div>
                                    <div class="promotion-prices"><span class="promotion-price">$30</span><span
                                            class="promotion-discount">$20</span></div>
                                </div>
                            </div>
                        </div>
                        <!-- 4 -->
                        <div class="col-md-12">
                            <div class="promotion-item">
                                ...
                                <div class="promotion-details">
                                    ...
                                    <div class="promotion-dot"></div>
                                    <div class="promotion-prices"><span class="promotion-price">$61</span><span
                                            class="promotion-discount">$44</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="sec3">
                ...
                <div class="container">
                    ...
                    <div class="inner">
                        <p> Numerous commentators have also referred to the supposed restaurant owner's eccentric habit of
                    ...
                    <div class="team-links">
                        ...
                        <!-- member 1 link -->
                        <div class="team-item">
                            <a href="{{ asset('frontend/team/mem1.html') }}" class="popup-with-move-anim">
                                <span class="team-details">More info</span>
                                <img src="{{ asset('frontend/images/team/thumbnails/1.jpg') }}" alt=""
                                    class="respimg">
                        ...
                        <!-- member 2 link -->
                        <div class="team-item">
                            <a href="{{ asset('frontend/team/mem2.html') }}" class="popup-with-move-anim">
                                <span class="team-details">More info</span>
                                <img src="{{ asset('frontend/images/team/thumbnails/1.jpg') }}" alt=""
                                    class="respimg">
                        ...
                        <!-- member 3 link -->
                        <div class="team-item">
                            <a href="{{ asset('frontend/team/mem3.html') }}" class="popup-with-move-anim">
                                <span class="team-details">More info</span>
                                <img src="{{ asset('frontend/images/team/thumbnails/1.jpg') }}" alt=""
                                    class="respimg">
                                <span class="chefname">Andy Moore</span>
                        ...
                        <!-- member 4 link -->
                        <div class="team-item">
                            <a href="{{ asset('frontend/team/mem4.html') }}" class="popup-with-move-anim">
                                <span class="team-details">More info</span>
                                <img src="{{ asset('frontend/images/team/thumbnails/1.jpg') }}" alt=""
                                    class="respimg">
                                <span class="chefname">Andy Moore</span>
