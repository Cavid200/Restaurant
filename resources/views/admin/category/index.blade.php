    ...
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                ...
                <div class="col-6">
                    <a style="float: right" href="{{ route('admin.category.create') }}" class="btn btn-primary"><i class="fas fa-plus-circle"></i></a>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($category->isActive==1)
                                                <a href="{{ route('admin.category.destroy',$category) }}" class="btn btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                                            @else
                                            <a href="{{ route('admin.category.active',$category) }}"class="btn btn-warning"><i class="fas fa-check-square"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
