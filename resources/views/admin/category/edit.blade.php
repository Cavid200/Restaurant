                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name="title"
                                                    placeholder="{{ __('title') }} *" value="{{ $category->title }}" required>
                                                @error('title')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name="subtitle"
                                                    placeholder="{{ __('subtitle') }} *" value="{{ $category->subtitle }}" required>
                                                @error('subtitle')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="checkbox" name="isActive" style="width: 20px; height:20px" @checked($category->isActive)>
                                            </div>
                                        </div>
                                    </div>
                                </div>
